...
4. Trang **Thư viện**: xem lại toàn bộ ảnh/video đã đồng bộ từ mọi tài khoản, nhóm theo ngày đồng bộ, có thể **Xem / Xoá / Chia sẻ** ngay trên web. Ảnh trong lưới dùng đúng **ảnh thu nhỏ có sẵn của Google Drive** (không tải nguyên bản gốc) để hiển thị nhanh, chỉ khi bấm vào xem toàn màn hình mới tải bản đầy đủ. Bấm vào ảnh/video mở khung xem toàn màn hình ngay trong trang (không rời trang) — vuốt trái/phải trong khung xem để chuyển sang ảnh kế tiếp/trước đó, đóng lại thì quay đúng về vị trí đã cuộn tới, không bị nhảy lên đầu trang. Nút **Chia sẻ** tải đúng file ảnh/video gốc về rồi mở hộp thoại chia sẻ của hệ điều hành (Web Share API) — gửi thẳng file thật sang Zalo, Facebook, Messenger... y như chia sẻ từ thư viện ảnh trên máy, không phải gửi link Google Drive.
